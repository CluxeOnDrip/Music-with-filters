...
execute(message) {
    ...
    .setAuthor(`<a:emoji_88:839463562212933662>|Loop is now ${queue.loop ? " enabled" : " disabled"}`, "https://cdn.discordapp.com/attachments/778600026280558617/781024479623118878/ezgif.com-gif-maker_1.gif")
