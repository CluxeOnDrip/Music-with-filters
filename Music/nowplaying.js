...
execute(message) {
    ...
    let nowPlaying = new MessageEmbed()
          .setAuthor('<a:emoji_88:839463562212933662> Now playing','https://cdn.discordapp.com/attachments/778600026280558617/781024479623118878/ezgif.com-gif-maker_1.gif','https://harmonymusic.tk')
          .setDescription(`[**${song.title}**](${song.url})`)
          .setThumbnail(song.thumbnail.url)
          .setColor("#F0EAD6")
          .setFooter(`<a:emoji_88:839463562212933662> Dj Atreya Requested by: ${message.author.username}#${message.author.discriminator}`, message.member.user.displayAvatarURL({ dynamic: true }))
      //if its a stream
      if(ms >= 10000) {
