...
async execute(message, args, client) {
    ...
    if (!channel) return attentionembed(message, "<a:emoji_60:839421840099246080> | Please join a Voice Channel first");
    //If not in the same channel return error
    if (serverQueue && channel !== message.guild.me.voice.channel)
      return attentionembed(message, `<a:emoji_86:839463518700568616> | You must be in the same Voice Channel as me`);
    //If no args return
    if (!args.length)
    ...
    if (!permissions.has("CONNECT"))
      return attentionembed(message, "<a:emoji_86:839463518700568616> | I need permissions to join your channel!");
    if (!permissions.has("SPEAK"))
      return attentionembed(message, "<a:emoji_88:839463562212933662> | I need permissions to speak in your channel");
